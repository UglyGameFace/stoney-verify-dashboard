...
export const env = {
  ...
  staffRoleNames: (process.env.STAFF_ROLE_NAMES || "Admin,Moderator,Staff").split(",").map((x) => x.trim()).filter(Boolean),
...
export function assertServerEnv() {
  ...
  required("SUPABASE_SERVICE_ROLE", env.supabaseServiceRole)
  required("DISCORD_TOKEN", env.discordToken)
  required("GUILD_ID", env.guildId)
  return true
}
