...
function sanitizePreferences(preferences) {
  ...
  return {
    ...
    layout: {
      home: sanitizeLayoutArea(incoming?.layout?.home, HOME_SECTION_KEYS, DEFAULTS.layout.home),
      members: sanitizeLayoutArea(incoming?.layout?.members, MEMBERS_SECTION_KEYS, DEFAULTS.layout.members),
    },
  };
}
